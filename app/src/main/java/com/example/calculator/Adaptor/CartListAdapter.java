...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public CartListAdapter(ArrayList<Product> foodDomains, Context context, ChangeNumberItemsListener changeNumberItemsListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.totalEachItem.setText( Double.toString((double) (foodDomains.get(position).getNumberInCart() * foodDomains.get(position).getPrice())).substring(0, Double.toString((double) (foodDomains.get(position).getNumberInCart() * foodDomains.get(position).getPrice())).indexOf(".") + 2));

        holder.num.setText(String.valueOf(foodDomains.get(position).getNumberInCart()));
        foodDomains.get(position).setNumberInCart(foodDomains.get(position).getNumberInCart());
